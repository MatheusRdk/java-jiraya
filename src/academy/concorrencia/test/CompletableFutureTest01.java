...
import academy.concorrencia.service.StoreService;
...
public class CompletableFutureTest01 {
    ...
    private static void searchPricesAsyncCompletableFuture(StoreService storeService){ //Nao precisa lançar excecoes com o join pois nao lança do tipo checked
        long start = System.currentTimeMillis();
